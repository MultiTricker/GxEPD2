...
void GxEPD2_074_E2741CS0B2::clearScreen(uint8_t value)
{
  writeScreenBuffer(value);
  refresh();
}

void GxEPD2_074_E2741CS0B2::writeScreenBuffer(uint8_t value)
{
...
void GxEPD2_074_E2741CS0B2::writeImage(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_074_E2741CS0B2::writeImage(const uint8_t* black, const uint8_t* color, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_074_E2741CS0B2::writeImagePart(const uint8_t bitmap[], int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
...
void GxEPD2_074_E2741CS0B2::writeImagePart(const uint8_t* black, const uint8_t* color, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  // Ignore color for B/W display
  if (black)
...
void GxEPD2_074_E2741CS0B2::writeNative(const uint8_t* data1, const uint8_t* data2, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  // For this display, native format is same as regular image format (1 bit per pixel)
  writeImage(data1, x, y, w, h, invert, mirror_y, pgm);
}

void GxEPD2_074_E2741CS0B2::drawImage(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeImage(bitmap, x, y, w, h, invert, mirror_y, pgm);
  refresh(x, y, w, h);
}

void GxEPD2_074_E2741CS0B2::drawImagePart(const uint8_t bitmap[], int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_074_E2741CS0B2::drawImage(const uint8_t* black, const uint8_t* color, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeImage(black, color, x, y, w, h, invert, mirror_y, pgm);
  refresh(x, y, w, h);
}

void GxEPD2_074_E2741CS0B2::drawImagePart(const uint8_t* black, const uint8_t* color, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_074_E2741CS0B2::drawNative(const uint8_t* data1, const uint8_t* data2, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeNative(data1, data2, x, y, w, h, invert, mirror_y, pgm);
  refresh(x, y, w, h);
}

void GxEPD2_074_E2741CS0B2::refresh(bool partial_update_mode)
{
  // COG initialization
  _cogInitialization();
  // DC/DC soft-start
...
void GxEPD2_074_E2741CS0B2::refresh(int16_t x, int16_t y, int16_t w, int16_t h)
{
  refresh(false); // no partial update support
}

void GxEPD2_074_E2741CS0B2::powerOff()
{
  _PowerOff();
}

void GxEPD2_074_E2741CS0B2::hibernate()
{
  _PowerOff();
  if (_rst >= 0)
  {
...
void GxEPD2_074_E2741CS0B2::_sendIndexData(uint8_t index, const uint8_t* data, uint16_t len)
{
  _writeCommand(index);
...
void GxEPD2_074_E2741CS0B2::_PowerOn()
{
  if (!_power_is_on)
  {
...
void GxEPD2_074_E2741CS0B2::_PowerOff()
{
  if (_power_is_on)
  {
    // DCDC off sequence
...
void GxEPD2_074_E2741CS0B2::_cogInitialization()
{
...
void GxEPD2_074_E2741CS0B2::_dcDcSoftStart()
{
