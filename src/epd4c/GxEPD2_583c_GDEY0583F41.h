...
#ifndef _GxEPD2_583c_GDEY0583F41_H_
#define _GxEPD2_583c_GDEY0583F41_H_

#include "../GxEPD2_EPD.h"

class GxEPD2_583c_GDEY0583F41 : public GxEPD2_EPD
{
  public:
    // attributes
    ...
    static const GxEPD2::Panel panel = GxEPD2::GDEY0583F41;
    ...
    static const uint16_t full_refresh_time = 25000; // ms, e.g. 24000000us
    static const uint16_t partial_refresh_time = 25000; // ms, e.g. 24000000us
    // constructor
    GxEPD2_583c_GDEY0583F41(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    // methods (virtual)
