...
//
// based on Demo Example from Good
// Display:https://www.good-display.com/comp/xcompanyFile/downloadNew.do?appId=24&fid=2134&id=1555
...
// Controller: HX8717 :
// https://v4.cecdn.yun300.cn/100001_1909185148/HX8717-A_DS_preliminary_v01_230417.pdf
//
...
GxEPD2_0579c_GDEY0579F51::GxEPD2_0579c_GDEY0579F51(int16_t cs, int16_t dc,
...
void GxEPD2_0579c_GDEY0579F51::clearScreen(uint8_t black_value,
                                           uint8_t color_value) {
  // Serial.println("clearScreen");
  if (_needs_re_init)
    _InitDisplay();
...
void GxEPD2_0579c_GDEY0579F51::writeScreenBuffer(uint8_t black_value,
                                                 uint8_t color_value) {
...
void GxEPD2_0579c_GDEY0579F51::_writeLineFromImage(
    const uint8_t *black, const uint8_t *color, int16_t x, int16_t y, int16_t w,
    int16_t wbb, bool invert, bool pgm, bool lowside, bool trf) {
...
void GxEPD2_0579c_GDEY0579F51::_writeDataFromImage(
    const uint8_t *black, const uint8_t *color, int16_t x, int16_t y, int16_t w,
    int16_t h, int16_t wbb, int16_t hb, bool invert, bool mirror_y, bool pgm,
    bool lowside) {
  _startTransfer();
  for (int16_t i = 0; i < h; i++) {
    ...
    if (h == 1)
      y1 = i + y;
    _writeLineFromImage(black, color, x, y1, w, wbb, invert, pgm, lowside,
                        false);
    if (h > 1) {
      int16_t y1 = mirror_y ? hb - 1 - (i + y) : i + y;
      _writeLineFromImage(black, color, x, y1, w, wbb, invert, pgm, lowside,
...
void GxEPD2_0579c_GDEY0579F51::writeImage(const uint8_t bitmap[], int16_t x,
...
void GxEPD2_0579c_GDEY0579F51::writeImage(const uint8_t *black,
  ...
  if ((x1 < WIDTH / 2) && true) // MasterSide ****
  {
    ...
    if (h1 == HEIGHT) {
      ...
      _writeCommand(0x10);
      _writeDataFromImage(black, color, dx, dy, pw_w, h1, wbb, h, invert,
                          mirror_y, pgm, true);
    } else {
      for (int16_t i = 0; i < h1; i++) {
        int16_t ybm = !mirror_y ? h - 1 - dy - i : dy + i;
        if (((y1 + i) % 2 == 0) &&
            ((y1 + i) < HEIGHT / 2)) { // shows at 0, half height
          int16_t pw_y = 2 * (y1 + i);
          _setPartialRamAreaMaster(pw_x, pw_y, pw_w, 1);
          _writeCommand(0x10);
          _writeLineFromImage(black, color, dx, ybm, pw_w, wbb, invert, pgm,
                              true, true);
        }
        if (((i + y1) % 2 == 1) &&
            ((i + y1) <
             HEIGHT / 2)) { // shows at 0, half height, completes half height
          int16_t pw_y = 2 * (i + y1);
          _setPartialRamAreaMaster(pw_x, pw_y, pw_w, 1);
          _writeCommand(0x10);
          _writeLineFromImage(black, color, dx, ybm, pw_w, wbb, invert, pgm,
        ...
        if (((i + y1) % 2 == 0) && ((i + y1) >= HEIGHT / 2) &&
            (true)) { // shows at half height the right part
  ...
  if ((x1 + w1 > WIDTH / 2) && true) // SlaveSide ****
  {
    ...
    if ((h1 == HEIGHT) && true) {
      ...
      _writeCommand(0x10);
      _writeDataFromImage(black, color, xbm, dy, pw_w, h1, wbb, h, invert,
                          mirror_y, pgm, false);
    } else {
      for (int16_t i = 0; i < h1; i++) {
        int16_t ybm = !mirror_y ? h - 1 - dy - i : dy + i;
        if (((i + y1) % 2 == 0) &&
            ((i + y1) < HEIGHT / 2)) { // shows at 0, half height
          int16_t pw_y = 2 * (i + y1);
          _setPartialRamAreaSlave(pw_x, pw_y, pw_w, 1);
          _writeCommand(0x10);
          _writeLineFromImage(black, color, xbm, ybm, pw_w, wbb, invert, pgm,
                              false, true);
        }
        if (((i + y1) % 2 == 1) &&
            ((i + y1) <
...
void GxEPD2_0579c_GDEY0579F51::writeImagePart(
  ...
  writeImagePart(bitmap, 0, x_part, y_part, w_bitmap, h_bitmap, x, y, w, h,
                 invert, mirror_y, pgm);
}
...
void GxEPD2_0579c_GDEY0579F51::writeImagePart(
  ...
  if ((x1 + w1 > WIDTH / 2) && true) // SlaveSide ****
  {
    ...
    if ((h1 == HEIGHT) && true) {
      _setPartialRamAreaSlave(pw_x, 0, pw_w, HEIGHT);
      _writeCommand(0x10);
      _writeDataFromImage(black, color, x_part + WIDTH / 2, dy, pw_w, h1, wbb,
                          h, invert, mirror_y, pgm, false);
    } else {
      for (int16_t i = 0; i < h1; i++) {
        int16_t ybm = !mirror_y ? h_bitmap - 1 - dy - i : dy + i;
        int16_t xbm = dx + (w1 - pw_w);
...
void GxEPD2_0579c_GDEY0579F51::_writeLineFromNative(const uint8_t *native,
                                                    int16_t x, int16_t y,
                                                    int16_t w, int16_t wbb,
                                                    bool invert, bool pgm,
                                                    bool trf) {
  if (trf)
    _startTransfer();
...
void GxEPD2_0579c_GDEY0579F51::_writeDataFromNative(
    const uint8_t *native, int16_t x, int16_t y, int16_t w, int16_t h,
    int16_t wbb, int16_t hb, bool invert, bool mirror_y, bool pgm) {
  // Serial.print("_writeDataFromNative("); Serial.print(x); Serial.print(", ");
  // Serial.print(y); Serial.print(w); Serial.print(", "); Serial.print(h);
  // Serial.print(", "); Serial.print(wbb); Serial.print(", ");
  // Serial.print(hb); Serial.print(", "); Serial.println(")");
  _startTransfer();
  for (int16_t i = 0; i < h; i++) {
    int16_t y1 = !mirror_y ? hb - 1 - (i + y) : i + y;
...
void GxEPD2_0579c_GDEY0579F51::writeNative(const uint8_t *data1,
  ...
  if ((x1 < WIDTH / 2) && true) // MasterSide ****
  {
    ...
    if ((h1 == HEIGHT) && true) {
      _setPartialRamAreaMaster(pw_x, 0, pw_w, HEIGHT);
      _writeCommand(0x10);
      _writeDataFromNative(data1, dx, dy, pw_w, h1, wbb, h, invert, mirror_y,
                           pgm);
    } else {
      for (int16_t i = 0; i < h1; i++) {
        int16_t ybm = !mirror_y ? h - 1 - dy - i : dy + i;
  ...
  if ((x1 + w1 > WIDTH / 2) && true) // SlaveSide ****
  {
    ...
    if ((h1 == HEIGHT) && true) {
      _setPartialRamAreaSlave(pw_x, 0, pw_w, HEIGHT);
      _writeCommand(0x10);
      _writeDataFromNative(data1, xbm, dy, pw_w, h1, wbb, h, invert, mirror_y,
                           pgm);
    } else {
      for (int16_t i = 0; i < h1; i++) {
        int16_t ybm = !mirror_y ? h - 1 - dy - i : dy + i;
        if (((i + y1) % 2 == 0) && ((i + y1) < HEIGHT / 2) &&
            (true)) { // shows at 0, half height
          int16_t pw_y = 2 * (i + y1);
          _setPartialRamAreaSlave(pw_x, pw_y, pw_w, 1);
          _writeCommand(0x10);
        ...
        if (((i + y1) % 2 == 1) && ((i + y1) < HEIGHT / 2) &&
            (true)) { // shows at 0, half height, completes half height
          int16_t pw_y = 2 * (i + y1);
          _setPartialRamAreaSlave(pw_x, pw_y, pw_w, 1);
          _writeCommand(0x10);
          _writeLineFromNative(data1, xbm, ybm, pw_w, wbb, invert, pgm, true);
...
void GxEPD2_0579c_GDEY0579F51::writeNativePart(
    const uint8_t *data1, const uint8_t *data2, int16_t x_part, int16_t y_part,
    int16_t w_bitmap, int16_t h_bitmap, int16_t x, int16_t y, int16_t w,
    int16_t h, bool invert, bool mirror_y, bool pgm) {
  // Serial.print("writeNativePart("); Serial.print(x_part); Serial.print(", ");
  // Serial.print(y_part); Serial.print(", "); Serial.print(w_bitmap);
  // Serial.print(", "); Serial.print(h_bitmap); Serial.print(", ");
  // Serial.print(x); Serial.print(", "); Serial.print(y); Serial.print(", ");
  // Serial.print(w); Serial.print(", "); Serial.print(h); Serial.println(")");
...
void GxEPD2_0579c_GDEY0579F51::drawImage(const uint8_t bitmap[], int16_t x,
                                         int16_t y, int16_t w, int16_t h,
...
void GxEPD2_0579c_GDEY0579F51::drawImagePart(const uint8_t bitmap[],
...
void GxEPD2_0579c_GDEY0579F51::drawImage(const uint8_t *black,
                                         const uint8_t *color, int16_t x,
                                         int16_t y, int16_t w, int16_t h,
                                         bool invert, bool mirror_y, bool pgm) {
...
void GxEPD2_0579c_GDEY0579F51::drawImagePart(
    const uint8_t *black, const uint8_t *color, int16_t x_part, int16_t y_part,
    int16_t w_bitmap, int16_t h_bitmap, int16_t x, int16_t y, int16_t w,
    int16_t h, bool invert, bool mirror_y, bool pgm) {
...
void GxEPD2_0579c_GDEY0579F51::drawNative(const uint8_t *data1,
                                          const uint8_t *data2, int16_t x,
                                          int16_t y, int16_t w, int16_t h,
                                          bool invert, bool mirror_y,
                                          bool pgm) {
...
void GxEPD2_0579c_GDEY0579F51::refresh(int16_t x, int16_t y, int16_t w,
                                       int16_t h) {
...
void GxEPD2_0579c_GDEY0579F51::powerOff() { _PowerOff(); }
...
void GxEPD2_0579c_GDEY0579F51::_setPartialRamAreaMaster(uint16_t x, uint16_t y,
                                                        uint16_t w, uint16_t h,
                                                        bool partial_mode) {
  // Serial.print("_setPartialRamAreaMaster("); Serial.print(x); Serial.print(",
  // "); Serial.print(y); Serial.print(", "); Serial.print(w); Serial.print(",
  // "); Serial.print(h); Serial.println(")");
  _setPartialRamArea(x, y, w, h, 0x01, partial_mode);
}
void GxEPD2_0579c_GDEY0579F51::_setPartialRamAreaSlave(uint16_t x, uint16_t y,
                                                       uint16_t w, uint16_t h,
                                                       bool partial_mode) {
  // Serial.print("_setPartialRamAreaSlave("); Serial.print(x); Serial.print(",
  // "); Serial.print(y); Serial.print(", "); Serial.print(w); Serial.print(",
  // "); Serial.print(h); Serial.println(")");
  _setPartialRamArea(x, y, w, h, 0x02, partial_mode);
}
void GxEPD2_0579c_GDEY0579F51::_setPartialRamAreaBoth(uint16_t x, uint16_t y,
                                                      uint16_t w, uint16_t h,
                                                      bool partial_mode) {
  // Serial.print("_setPartialRamAreaBoth("); Serial.print(x); Serial.print(",
  // "); Serial.print(y); Serial.print(", "); Serial.print(w); Serial.print(",
  // "); Serial.print(h); Serial.println(")");
  _setPartialRamArea(x, y, w, h, 0x00, partial_mode);
}

void GxEPD2_0579c_GDEY0579F51::_setPartialRamArea(uint16_t x, uint16_t y,
                                                  uint16_t w, uint16_t h,
                                                  uint8_t select,
                                                  bool partial_mode) {
  // Serial.print("_setPartialRamArea("); Serial.print(x); Serial.print(", ");
  // Serial.print(y); Serial.print(", "); Serial.print(w); Serial.print(", ");
  // Serial.print(h); Serial.println(")");
