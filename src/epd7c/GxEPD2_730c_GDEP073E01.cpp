...
// https://www.good-display.com/comp/xcompanyFile/downloadNew.do?appId=24&fid=2006&id=1435
...
GxEPD2_730c_GDEP073E01::GxEPD2_730c_GDEP073E01(int16_t cs, int16_t dc,
                                               int16_t rst, int16_t busy)
    : GxEPD2_EPD(cs, dc, rst, busy, LOW, 20000000, WIDTH, HEIGHT, panel,
...
void GxEPD2_730c_GDEP073E01::clearScreen(uint8_t black_value,
                                         uint8_t color_value) {
...
void GxEPD2_730c_GDEP073E01::writeScreenBuffer(uint8_t black_value,
                                               uint8_t color_value) {
...
void GxEPD2_730c_GDEP073E01::writeImage(const uint8_t bitmap[], int16_t x,
  ...
  if (_paged && (x == 0) && (w == int16_t(WIDTH)) && (h < int16_t(HEIGHT))) {
    ...
    for (uint32_t i = 0; i < uint32_t(WIDTH) * uint32_t(h) / 8; i++) {
      ...
      for (int16_t k = 0; k < 4; k++) {
        uint8_t data2 =
            (data & 0x80 ? 0x10 : 0x00) | (data & 0x40 ? 0x01 : 0x00);
        data <<= 2;
        _transfer(data2);
      }
    }
...
void GxEPD2_730c_GDEP073E01::writeImage(const uint8_t *black,
...
void GxEPD2_730c_GDEP073E01::writeImagePart(const uint8_t bitmap[],
...
void GxEPD2_730c_GDEP073E01::writeImagePart(
...
void GxEPD2_730c_GDEP073E01::writeNative(const uint8_t *data1,
      ...
      for (int16_t i = 0; i < int16_t(HEIGHT); i++) {
        for (int16_t j = 0; j < int16_t(WIDTH); j += 2) {
          ...
          if (data1) {
            if ((j >= x) && (j < x + w) && (i >= y) && (i < y + h)) {
              uint32_t idx =
                  mirror_y ? (j - x) / 2 + uint32_t((h - 1 - (i - y))) * wb
                           : (j - x) / 2 + uint32_t(i - y) * wb;
              if (pgm) {
#if defined(__AVR) || defined(ESP8266) || defined(ESP32)
...
void GxEPD2_730c_GDEP073E01::writeNativePart(
...
void GxEPD2_730c_GDEP073E01::drawImage(const uint8_t bitmap[], int16_t x,
                                       int16_t y, int16_t w, int16_t h,
                                       bool invert, bool mirror_y, bool pgm) {
...
void GxEPD2_730c_GDEP073E01::drawImagePart(const uint8_t bitmap[],
                                           int16_t x_part, int16_t y_part,
                                           int16_t w_bitmap, int16_t h_bitmap,
                                           int16_t x, int16_t y, int16_t w,
                                           int16_t h, bool invert,
...
void GxEPD2_730c_GDEP073E01::drawImage(const uint8_t *black,
                                       const uint8_t *color, int16_t x,
                                       int16_t y, int16_t w, int16_t h,
                                       bool invert, bool mirror_y, bool pgm) {
...
void GxEPD2_730c_GDEP073E01::drawImagePart(
    const uint8_t *black, const uint8_t *color, int16_t x_part, int16_t y_part,
    int16_t w_bitmap, int16_t h_bitmap, int16_t x, int16_t y, int16_t w,
    int16_t h, bool invert, bool mirror_y, bool pgm) {
...
void GxEPD2_730c_GDEP073E01::drawNative(const uint8_t *data1,
                                        const uint8_t *data2, int16_t x,
                                        int16_t y, int16_t w, int16_t h,
                                        bool invert, bool mirror_y, bool pgm) {
...
void GxEPD2_730c_GDEP073E01::refresh(int16_t x, int16_t y, int16_t w,
                                     int16_t h) {
  _PowerOn();
  _writeCommand(0x12); // Display Refresh
  _writeData(0x00);
...
void GxEPD2_730c_GDEP073E01::powerOff() { _PowerOff(); }
...
void GxEPD2_730c_GDEP073E01::writeDemoBitmap(const uint8_t *data1,
                                             const uint8_t *data2, int16_t x,
                                             int16_t y, int16_t w, int16_t h,
                                             int16_t mode, bool mirror_y,
                                             bool pgm) {
  (void)mode;
  if (data1) {
    // Serial.print("writeNative("); Serial.print(x); Serial.print(", ");
...
void GxEPD2_730c_GDEP073E01::drawDemoBitmap(const uint8_t *data1,
                                            const uint8_t *data2, int16_t x,
                                            int16_t y, int16_t w, int16_t h,
                                            int16_t mode, bool mirror_y,
                                            bool pgm) {
