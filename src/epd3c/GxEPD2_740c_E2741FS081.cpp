...
#include "GxEPD2_740c_E2741FS081.h"
...
void GxEPD2_740c_E2741FS081::clearScreen(uint8_t black_value, uint8_t color_value)
{
  writeScreenBuffer(black_value, color_value);
  refresh();
}

void GxEPD2_740c_E2741FS081::writeScreenBuffer(uint8_t value)
{
...
void GxEPD2_740c_E2741FS081::writeImage(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeImage(bitmap, (const uint8_t*)0, x, y, w, h, invert, mirror_y, pgm);
}

void GxEPD2_740c_E2741FS081::writeImage(const uint8_t* black, const uint8_t* color, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_740c_E2741FS081::writeImagePart(const uint8_t bitmap[], int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeImagePart(bitmap, (const uint8_t*)0, x_part, y_part, w_bitmap, h_bitmap, x, y, w, h, invert, mirror_y, pgm);
}

void GxEPD2_740c_E2741FS081::writeImagePart(const uint8_t* black, const uint8_t* color, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  if (!black && !color) return;
  delay(1); // yield() to avoid WDT on ESP8266 and ESP32
...
void GxEPD2_740c_E2741FS081::writeNative(const uint8_t* data1, const uint8_t* data2, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_740c_E2741FS081::drawImage(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeImage(bitmap, x, y, w, h, invert, mirror_y, pgm);
  refresh(x, y, w, h);
}

void GxEPD2_740c_E2741FS081::drawImagePart(const uint8_t bitmap[], int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_740c_E2741FS081::drawImage(const uint8_t* black, const uint8_t* color, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
  writeImage(black, color, x, y, w, h, invert, mirror_y, pgm);
  refresh(x, y, w, h);
}

void GxEPD2_740c_E2741FS081::drawImagePart(const uint8_t* black, const uint8_t* color, int16_t x_part, int16_t y_part, int16_t w_bitmap, int16_t h_bitmap,
    int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_740c_E2741FS081::drawNative(const uint8_t* data1, const uint8_t* data2, int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm)
{
...
void GxEPD2_740c_E2741FS081::refresh(int16_t x, int16_t y, int16_t w, int16_t h)
{
  refresh(false); // no partial update support
}

void GxEPD2_740c_E2741FS081::powerOff()
{
  _PowerOff();
}

void GxEPD2_740c_E2741FS081::hibernate()
{
  _PowerOff();
  if (_rst >= 0)
  {
...
void GxEPD2_740c_E2741FS081::_PowerOff()
{
  if (_power_is_on)
  {
    // DCDC off sequence
...
void GxEPD2_740c_E2741FS081::_InitDisplay()
{
  if (_rst >= 0)
  {
...
void GxEPD2_740c_E2741FS081::_cogInitialization()
{
...
void GxEPD2_740c_E2741FS081::_dcDcSoftStart()
{
...
void GxEPD2_740c_E2741FS081::_displayRefreshAndPowerDown()
{
